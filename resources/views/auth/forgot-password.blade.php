...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Forgot Password | Dynasti Education Center</title>
                ...
                <div class="grid w-full overflow-hidden rounded-[2rem] bg-white shadow-2xl lg:grid-cols-[1fr_1fr]">
                    <div class="flex flex-col justify-between bg-blue-600 px-8 py-10 text-white md:px-12 md:py-14">
                        <div>
                            ...
                            <div class="mt-14 max-w-lg">
                                <p class="text-sm font-semibold uppercase tracking-[0.3em] text-blue-100">Account Recovery</p>
                                ...
                                <p class="mt-6 text-base leading-7 text-blue-100 md:text-lg">
                                    Masukkan email yang terdaftar dan kami akan kirimkan tautan reset password ke inbox Anda.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="mt-12 rounded-2xl bg-white/10 p-5 backdrop-blur-sm">
                            ...
                            <p class="mt-3 text-sm text-blue-100">
                                Pastikan email yang digunakan sama dengan email saat registrasi agar tautan reset dapat diterima dengan benar.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center px-6 py-10 md:px-10 md:py-14">
                        <div class="mx-auto w-full max-w-md">
                            <div class="mb-8">
                                <p class="text-sm font-semibold uppercase tracking-[0.25em] text-blue-600">Forgot Password</p>
                                <h3 class="mt-3 text-3xl font-bold text-gray-900">Reset password</h3>
