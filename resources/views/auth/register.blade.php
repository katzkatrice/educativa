...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Register | Dynasti Education Center</title>
                ...
                <div class="grid w-full overflow-hidden rounded-[2rem] bg-white shadow-2xl lg:grid-cols-[0.95fr_1.05fr]">
                    <div class="flex flex-col justify-between bg-blue-600 px-8 py-10 text-white md:px-12 md:py-14">
                        <div>
                            ...
                            <div class="mt-14 max-w-lg">
                                <p class="text-sm font-semibold uppercase tracking-[0.3em] text-blue-100">Portal Register</p>
                                <h2 class="mt-4 text-3xl font-bold leading-tight md:text-5xl">
                                    Buat akun dan mulai perjalanan akademik Anda.
                                </h2>
                                <p class="mt-6 text-base leading-7 text-blue-100 md:text-lg">
                                    Daftar untuk mengakses layanan bimbingan, publikasi ilmiah, dan konsultasi profesional yang terintegrasi.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="mt-12 space-y-4">
                            <div class="rounded-2xl bg-white/10 p-5 backdrop-blur-sm">
                                <p class="text-sm font-semibold uppercase tracking-[0.2em] text-blue-100">Keuntungan Bergabung</p>
                                <ul class="mt-4 space-y-3 text-sm text-blue-100">
                                    <li>Akses mudah ke layanan edukasi dan mentoring.</li>
                                    <li>Konsultasi akademik dalam satu dashboard.</li>
                                    <li>Tampilan yang konsisten dengan identitas Dynasti.</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center px-6 py-10 md:px-10 md:py-14">
                        <div class="mx-auto w-full max-w-md">
                            <div class="mb-8">
                                <p class="text-sm font-semibold uppercase tracking-[0.25em] text-blue-600">Create Account</p>
                                <h3 class="mt-3 text-3xl font-bold text-gray-900">Daftar akun baru</h3>
                                <p class="mt-3 text-sm leading-6 text-gray-500">
                                    Lengkapi data berikut untuk membuat akun Dynasti Education Center.
                                </p>
                            </div>
